...
try {
  ...
  Get-ChildItem $env:windir\System32\LogFiles\WMI\RtBackup -Recurse -ErrorAction SilentlyContinue | Out-File $global:resDir\RTBackup.txt 
  ...
  Write-Log "Access Denied: Cannot access the RTBackup folder, please run the script as SYSTEM with PSExec"
}
catch {
  Write-Log "Error occurred accessing the RTBackup folder"
}
...
if ($sessions) {
  $sessions | Select-Object -Skip 3 | Select-Object -First ($sessions.Length - 5) | ForEach-Object  {
    $sessionName = $_ -split '\s+' | Select-Object -First 1
    $cmd = "logman -ets query " + $sessionName + " >""" + $global:resDir + "\ETWSession-" + $sessionName + ".txt""" + $RdrErr
    Write-Log $cmd
    Invoke-Expression ($cmd) | Out-File -FilePath $global:outfile -Append
  }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDgvHFjwAT+nQrJ
# 8NtEseB18UmKDECEnI5SSrE57nTuoaCCDXYwggX0MIID3KADAgECAhMzAAADrzBA
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIN9vxsOdA9fEu52FwHLCCL8p
# Bv6sITn6vLWGUDlR4bkbMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAhf9gT7W4Gm+AaBehiZ9ijECxzgbhGc6DiOdrItRQNEu8+FvFeeKN4awZ
# XfdiX5Z6FinlP4ziVsFaxRctLIVhPZHoIl4eYh9yc99fMuPIhJ4lGHRoudDMQfNA
# JHhxdNq4oFPz6isFU8qQr547HjprGR+appOVAV6Jysh/xP8nlJf8l354ofLNifAA
# spuSFCvLW63e7b1vkzsv0VFR6TttlV3tDsXkY7Uxeoj9Unqdbdg7ioD9R2z3ysLG
# 3CmOo4JucWXmpm+XB9CxiIZBqvI41tDgSXMlqQ6ZxxpapD9pgi+tbnZaN707eUR8
# siWL+PaOKUyjIfF3zpLaIi5ZNgtnWaGCF5QwgheQBgorBgEEAYI3AwMBMYIXgDCC
# F3wGCSqGSIb3DQEHAqCCF20wghdpAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFSBgsq
# hkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCD8G3XnOOInO27lnoPQRPd5KCu/M6HtUqsaFJI/snyZoAIGZkXzAp1A
# GBMyMDI0MDYxMjE1MDAzNy45NTFaMASAAgH0oIHRpIHOMIHLMQswCQYDVQQGEwJV
...
# CSqGSIb3DQEJBDEiBCDtkiGj3pjUf3Ha7A05YfGheWwKI6h7dESEZRY7TVgjjzCB
...
# qJZdLBOLHNhuqWUwDQYJKoZIhvcNAQELBQAEggIAHWZRzttEm1BqMEf8J/HCioNU
# xe9OZNi7hZUxr7bi2Z37agy4u2AR+L93E5NcYwBMnlOv/BVKl0jVYIujizGrfxgW
# r4/6ehZaO1h3OryUcVUG4qVYoD+Ycdu9eQSXUeRAtJsCFyny/j2Los3zlBha6zE5
# 5WDeEee1kwbenHarKJuKWUrMbgPSeVSuPJFawDwo093k2hBrjTmbS/JrGkznWJ8f
# ydgE+FMUjQEUCeCFNXjgK+DhT7PdgbJi/l1JRxnNpI1N4jDE8Cv20qGOgde0h5/6
# sFvq49fhfJh+i1a9Dwv/VFcHasymW663REPWcpLq+KOQwUiiIDnK47WdFaphvpli
# 6r/Hx6N/1oo0f5FJ21L1zThCVd6sauXyy+mUC6zX2GcHx9qko3aFrHxQYxIoTDfl
# kql96i6GihaQDTwVmRcVeudut1Q/l4Fa+x7cS+vPt3RFG4Q8xCNFRS2rzSJOOvF+
# Wx394rld2dODt1CG+son3gOC9Vj18pJJGjVdbqkM+veWddsaUP759rICwihXeX8y
# 3ArTPBYnGOrjyai0E55Fy+6SI6WNfb6V8u0peziDUqaCMJyq6k/sQn8H5zOgpLab
# Wq451PCiSBsmglJjwoPDou8eWbbQNszW5nV9CuSZkjPxuCuBMgt/DsxcNJ18tfkG
# GtmX9stxifaaaKveWj4=

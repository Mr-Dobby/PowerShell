# Script: tss_ExportVPNProfiles.ps1
...
function CollectNET_VpnProfiles {
	...
	# Export each VPN profile to an XML file
	$vpns | ForEach-Object {
		$profileName = $_.InstanceID
		$profileXml = $_.ProfileXML
		$outFile = $PrefixTime + $profileName + "_" + $TssPhase + ".xml"
		try {
			[System.IO.File]::WriteAllText($outFile, $profileXml)
		} catch {
			Write-Host "Error exporting $($profileName): $_"
		}
	}
}
CollectNET_VpnProfiles


# SIG # Begin signature block
# MIIoLQYJKoZIhvcNAQcCoIIoHjCCKBoCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBtKSRwgdXYPHB0
# t13wNuULtGIIp4QbNPs7zkKXMGoq86CCDXYwggX0MIID3KADAgECAhMzAAADrzBA
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJ5JBw/Ec2Q5x/pBNfhIb4Ec
# BixTPzCawX1Jwmn2gWtvMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAJcTO7rrtH5rbGMLPwwLkyDHwoSosMxsbtJ6z/L+w6T30lw4bXpj2VM6z
# f0XajW/i4ucyXG8qZpCicIvVKfV1SeZc1JajR9EAMH9DEcyo8QFpmELUn5yP6LwK
# PQLLFxtiTorxSro1+CfTOYg7j/0paU9fou6DWOkc8a7z/hlULMrXyv/T1q5dhoLX
# eBUqmfjXUNy5dyAuAm77rVCBTpPC79ChW4Kd94FPDLiqlRmzVV8mu7bvlZbQn1UV
# zb3NBQaTJutbiaTlW2SfHn7/Nqi1AsUYXHvnVFxqOdwFLYdQnCPyetSzTP+RN8Ji
# iIe79U41uQDlHRBgiHpzaMJzMtzGx6GCF5cwgheTBgorBgEEAYI3AwMBMYIXgzCC
# F38GCSqGSIb3DQEHAqCCF3AwghdsAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFSBgsq
# hkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCCzRBGB5L/42UnsnCqYUbvuZnx90P0cN1xtsesGBZvpxgIGZkYkVK1a
# GBMyMDI0MDYxMjE1MDAzOC41NDFaMASAAgH0oIHRpIHOMIHLMQswCQYDVQQGEwJV
...
# MC8GCSqGSIb3DQEJBDEiBCC7zwFyYezhzNSBQWzK1zz8UJPU6KZ0MclPuWigwKLe
...
# suTSQ/CeF8beyhNi1J8wDQYJKoZIhvcNAQELBQAEggIAcBg5FvQckPWuKkTqLbRV
# vrq1pVpoHzOUynzeTcVtUjw3JCmDQrdehWYPKvi2btunmY/I8VZ64nl8pGn6nlhq
# Wnz7/ucjKtTnHkXwmxCMsZ+1gc4LSa0A8rVT9gUpddmIZE5Voss7SwN0fVm3UWr+
# Dxuq38JpSQZyO/gI+k/qq2lg2nQoOqGVbXiYBYC8BY18PUGw0d0RccsfUMaPEBH4
# SbwhWArO52I/H5UdGv+q7fs7rnGbHOZyP774c/JckXP4tHQ2P4+AVOnBAd5bnaix
# odcgeGG9q3jXBS3j8oibkwtNOj4Pc+vwYiXW2PGJb734uEjTF/NqFvTosNqhndoA
# jCG5p60IjUkmeg9G7wSBJMNHNF6Dc+nvSNCJVVeFiS0NHSMaSqAjMUC9W89Is8SW
# CAMdfUIFlaKkPb4zN4P+vBa+qtrRA51DFagfRlqXJqcnPrlL+tAcFZ2sRdGeZPKn
# Q1ELE/NlAVHlPHVhsXf60UPgwq4d6TqHVjtZ5RuXXrJsBkoai7fnTq8SZNajDegG
# ZzEKCp6vheELysHIdp+1OuztM84dOno4e1ZjgpNCVDVQFL+ogoYd2d0DZ+qowutt
# TFxSy+OqlsyOlWSb/GI5gfnbAPySJDzE0ujoJd32pjDftg2G68m6z6m8byokcnA2
# je8y56dNHJSn6TDe2EYhlj8=

<#
.SYNOPSIS
   Scenario module for collecting Microsoft AVD MSIX App Attach related data
...
$msrdLogPrefix = "MSIXAA"

# Collecting MSIX App Attach troubleshooting data
Function msrdCollectUEX_AVDMSIXAALog {
    param( [bool[]]$varsMSIXAA )

    " " | Out-File -Append $global:msrdOutputLogFile
    msrdLogMessage $LogLevel.Info "$(msrdGetLocalizedText "msixaamsg")"
    msrdLogMessageAssistMode "$(msrdGetLocalizedText "msixaamsg")"
    ...
    if ($varsMSIXAA[0]) {
        ...
        msrdLogMessage $LogLevel.Normal -LogPrefix $msrdLogPrefix -Message "MSIXAA filtered RemoteDesktopServices event logs"
        $eventlog = "RemoteDesktopServices"
        $msixaalog = $global:msrdEventLogFolder + $env:computername + "_MSIXAA_filtered.evtx"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDeEgSATRgfFSw+
# yt9w84tYkAkUfVbUyKRVDI1hg/JRlqCCDXYwggX0MIID3KADAgECAhMzAAADrzBA
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIDZC9JOlLYQRDaZhT0Tl6lNl
# 9CJRTLqgfuZJausGJpsQMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAi68n0QbX7cTgktHZFnnvvp+/jXDiS61Bo19w8RDunfaZfBGVyRB/sRmk
# 6wDEO3PM9R70Cj5RPCe9BQgpInH54c3dLC+Wu+pTM8eTperJOoRmDG8rrKwBuPeh
# FGhCAuitzUS3GNHafBfWlqvIwakSi0miKRyPnQY5mrOWo8Zwwd2YFYL8MYl54bA+
# H/snfn7Gh9RKBWv2CeN1nK8KW2tE0Xbhx7/IIH4HcUcGVgIuDv7EAxXz4urB9lnZ
# vIuMx3fxBtCMxMP+KmIeqcChj/gnIkmTpeV/4NFxkQd4VGJT8MwttiR8Yd5c88FH
# x2Yp1iQeSCXyhowFeAUozhNrpthVHKGCFyswghcnBgorBgEEAYI3AwMBMYIXFzCC
# FxMGCSqGSIb3DQEHAqCCFwQwghcAAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFZBgsq
# hkiG9w0BCRABBKCCAUgEggFEMIIBQAIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCAmKLAhGw8xxGkB/bvOK8SucbrM4Sp7uB9Bs9vNNBJu7QIGZlddmE72
# GBMyMDI0MDYxMjE1MDAzNy40NTZaMASAAgH0oIHYpIHVMIHSMQswCQYDVQQGEwJV
...
# BDEiBCCiCroOHxGMa9t2TbkSsof6ZMd1lNO4dF7w2VqDnOB+ozCB+gYLKoZIhvcN
...
# 90gwDQYJKoZIhvcNAQELBQAEggIABNwbv4V8+4WBF1dl+QZUhPxdHITLE0VfD8I2
# l14/8S2fGSycfv9ln1uD3tCWw03A1rawkmT3BPltkdxm21ZLmFDVePG7KPR7eUk4
# j3qWOR3fNaD7ZmQTau8jvKc9DPp5HDE5UxvGiyGU0O+2i3QghQh+yzIFYhXPBbO/
# xpeMruxyCyCbsudvyoQZatK1eQ4YzKa6OWC7v9A/rylHxp2uDmWAUseWGhH1+JcR
# x1biE/Q77agk6hYTt9YDxG7CHKkjpsFamhGcOUSaCsPJP8gqOF2JiLxi0LEOkSlu
# whhKATmAzLNrm89vE2ENI6V+YnKfWH6hlGdcbay0wtWjSRMWWM8aShd8C3Iwdral
# cVlnBQqituJCq3bw/gSXvNb2ijzOXIWswxCOKghdmfRxj4a+9zhR7rHvE0dQPqJL
# 9TOqOrZrgcGXThhY+tO2g2ieRb1qxbpFJ8I5F7C0mx3/1G0bhG7hBElTa4S1NVmn
# 42nDIU6EoMipcvQILvyGsLE6v5oizuf3vLg0rjiLQQn6oUrTBGxmNX3BmEPCYvsV
# gqqUZhdWT2ZETKId9I0kNDXYLv8w7084GEthslkDLATNwGgbUkjCavywamOLbuiH
# Nu8zETi2CduXtIu7QTu4xSsxkdeB5q/CyGghxfbXqTfOI2CcYpvb86PiCepuLZ+M
# p4ItPu4=

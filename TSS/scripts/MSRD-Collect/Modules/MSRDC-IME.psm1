...
$msrdLogPrefix = "IME"
$msrdIMELogFolder = $global:msrdBasicLogFolder + "IME\"
...
Function msrdGetIMERegKeys {
    ...
    $regs = @{
        ...
        'HKLM:\SYSTEM\CurrentControlSet\Control\Keyboard Layouts' = 'System-CCS-Control-KeyboardLayouts'
    }
...
Function msrdGetIMETree {
    ...
    $treeIME = "$msrdUserProfilesDir\$global:msrdUserprof\AppData\Roaming\Microsoft\IME"
    $treeInputMethod = "$msrdUserProfilesDir\$global:msrdUserprof\AppData\Roaming\Microsoft\InputMethod"
    $treeLocalIME = "$msrdUserProfilesDir\$global:msrdUserprof\AppData\Local\Microsoft\IME"

    $Commands = @(
        "tree $treeIME /f 2>&1 | Out-File -Append '" + $msrdIMELogFolder + $global:msrdLogFilePrefix + "tree_APPDATA-MS-IME.txt'"
        "tree $treeInputMethod /f 2>&1 | Out-File -Append '" + $msrdIMELogFolder + $global:msrdLogFilePrefix + "tree_APPDATA-MS-InputMethod.txt'"
        "tree $treeLocalIME /f 2>&1 | Out-File -Append '" + $msrdIMELogFolder + $global:msrdLogFilePrefix + "tree_LOCALAPPDATA-MS-IME.txt'"
        "tree '$env:windir\System32\IME' /f 2>&1 | Out-File -Append '" + $msrdIMELogFolder + $global:msrdLogFilePrefix + "tree_Win-Sys32-IME.txt'"
        "tree '$env:windir\IME' /f 2>&1 | Out-File -Append '" + $msrdIMELogFolder + $global:msrdLogFilePrefix + "tree_Win-IME.txt'"
    )
    msrdRunCommands -LogPrefix $msrdLogPrefix -CmdletArray $Commands -ThrowException:$False -ShowMessage:$True -ShowError:$True
}

# Collecting Input Method troubleshooting data
Function msrdCollectUEX_AVDIMELog {
    ...
    msrdLogMessage $LogLevel.Info "$(msrdGetLocalizedText "imemsg")" -silentException
    if ($global:msrdAudioAssistMode -eq 1) { msrdLogMessageAssistMode "$(msrdGetLocalizedText "imemsg")" }
    msrdCreateLogFolder $msrdIMELogFolder
    ...
    if ($varsIME[2]) {
        $Commands = @(
            "Get-Culture | fl * 2>&1 | Out-File -Append '" + $msrdIMELogFolder + $global:msrdLogFilePrefix + "Culture.txt'"
            "Get-WinUserLanguageList | fl * 2>&1 | Out-File -Append '" + $msrdIMELogFolder + $global:msrdLogFilePrefix + "WinUserLanguageList.txt'"
        )
        msrdRunCommands -LogPrefix $msrdLogPrefix -CmdletArray $Commands -ThrowException:$False -ShowMessage:$True -ShowError:$True
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDNQgCyFnQqbWTY
# Ukq4ol4OpCG7flyVMtfs5nJRiK8pjKCCDXYwggX0MIID3KADAgECAhMzAAADrzBA
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIHVD1MUS/d8K18lKcYo75o8c
# dXHWxSwiL1jNTA8XdB4sMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAl6xy3aNnyHLn8BBYPcoihdfm4cDOQ2NwgZaagvLjUUrxm7t0Hd4Esd/J
# Z1DMlBMK2tuIRQerZKuak6whWlPS7feyxQWuxIP4PnWPcdv6EqNefLs8IYpAM7d5
# KHtTCoFU8omVVhO4vNgv+xQcec4eQ8ESO+ruP+k5EMKAeg7N3HVdUTBX8gZc+rF+
# byDshhaXYsz4V9aWg0BBmvs4ZCrZONEp78AwJ3L7B0NXYXNiNTnKbDghbji/Qpuh
# x4Wjj6fTGVTan5pRh1kVzrBy2pvfMFa+pTmvbItqUhKubpXK4CPS3NtvY8JH3Bv8
# AX94WllgtwDKWsbrw+eLqae9M+v8r6GCFykwghclBgorBgEEAYI3AwMBMYIXFTCC
# FxEGCSqGSIb3DQEHAqCCFwIwghb+AgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFZBgsq
# hkiG9w0BCRABBKCCAUgEggFEMIIBQAIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCCAy5mHq2tnzyYu4roKTF/gL8zKMnPm+HD/AD+ptDyrJgIGZlc8wh9D
# GBMyMDI0MDYxMjE1MDAzOC4xNjNaMASAAgH0oIHYpIHVMIHSMQswCQYDVQQGEwJV
...
# IgQgsQPYYfpmfoepv5wbfxXbjfhxJBTgQ+K12mGUdJYvBhEwgfoGCyqGSIb3DQEJ
...
# MA0GCSqGSIb3DQEBCwUABIICAADj1E4QW8kX64l1D9wIlBzgXUy4Ht3zEN6wp5Y+
# s8DIKNjxuInChO36W57CUgCMkk1LPdBBVAIQ275ONJfmwKP8WABPZVbSzk3Fnfpe
# ZZDAtc/MFG8KXHP6s7Z4ANJZbc7wlsx+klBP6ywZI4YnoYisgAFzsKhsk3isshca
# hpimBvDy9bErNA6P9e0A9u+eXDE6rur0TrazFltzgJ56uM/UX8j6DWDe6szUjCdo
# oXUg0VIu579KhKEJfvYdbpUUzWW/2s+BG/R5P+qE6tmylAF9ZLGbxE/ugsF1/qz/
# znWAbiXPrzBV8xLo9W1+lr9s6vvraApjblV/wKwkLjXFlLOYGvOAPADB9OADbOVq
# P1zuLjEdlM9Ia+8+cwgsoyxF1fcutYOsRWHgN/DXb6w8Vxgww0y2Oo5nLWmjaDGO
# xu+YoMDsHvl2GOigyzv4x4A868CKR5frMCf5N+WroCpusQc6f+v/JtJJMTzWV+Gh
# +b7Ec/5rQ/ulDMQW1b4103Hvj7DEm1+rTpHOa4gmKRIDtglJk7E0NdTp2TIlZEaz
# cisPs3tMr/cfefFDKaTo89YtVozqSJik2MFimfXEflqp5ZHQw4STfood8EqorNlv
# 1z3B5dlVD7nW2fbnXdZtgTcGcXOexl+dWWBvtK0Pg0lAYtNzEqlTtnH4W9tQsuRM
# lOs+

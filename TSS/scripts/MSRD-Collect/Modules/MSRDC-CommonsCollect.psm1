...
Function msrdGetEventLogs {
    ...
    $EventHashtable.GetEnumerator() | ForEach-Object -Process {
        ...
        if (Get-WinEvent -ListLog $EventSource -ErrorAction Ignore) {
            ...
            msrdLogMessage $LogLevel.WarnLogFileOnly "[$LogPrefix] Event log '$EventSource' not found."
        }
    }
}
...
"@
        ...
        $msrdcMsgClosed = "MSRDC.exe has been closed. Waiting 20 seconds for the latest trace file(s) to get saved before continuing.`n"
        $msrdcMsgNotClosed = "MSRDC.exe has not been closed. The most recent ETL traces will NOT be available for troubleshooting! Continuing data collection.`n"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBQ62FDip7iPXFw
# VJwvocWyMgG73vAUqnppyH3oBctggaCCDYUwggYDMIID66ADAgECAhMzAAADri01
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIG87
# jZiWRFJwo3NUuENeab2CFG2EOSDHpBzvi/+EjhYXMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAms4ljPReDmTuC05yiAqVMUo+shnaldB/lTcV
# oKdTZuX0VuRUTBItcL9kaMRCNC1dL47lL+C5Os8aiOR5xMfZhIQR0fRMTdLlyg/4
# tJVtOiyeFtS9YH5xilZ9ogyw0SRv9htJqHgzR0yDVjT1cHtqqQ8hPpN5Ohr+X7Rr
# XJOHrq8nx33J5ASlEbYEL9o2i6fw0xq6XGR566PG7KbQmMYn4ixpHv3frz5LH2Rl
# +AEuAksclhtpLkKHzWIV3air86vK/uH/hTgyndPwwFQcY9q077mGTrSoC2bxKyTH
# mdv+HSNpiH+i2mbuqQupDvrh+HYhRuEcH5yLP7L/fyltIqY4Q6GCF5QwgheQBgor
# BgEEAYI3AwMBMYIXgDCCF3wGCSqGSIb3DQEHAqCCF20wghdpAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFSBgsqhkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCC0CQUep5fhr2LN/t9/Ih6LRLOj7pr2I4Hg
# gs3bNK/IWwIGZkZOOebzGBMyMDI0MDYxMjE1MDAzOS41NTRaMASAAgH0oIHRpIHO
...
# CyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCC7Mj94a7JQcQjRCLPGE9tRwnP0
# SD+pH3tLSGMF6o4ZATCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIE9QdxSV
...
# YvztJJOK0/jyPzMSAdnjdqHXXs0fd5SMr5owDQYJKoZIhvcNAQELBQAEggIAE+Gg
# 27i8C8sgZ8GPpWQgde61cXrho9BmBOpHF4Nui0Gh1XE4opZqIT4Jvn9VUylGZ7sh
# lBX3fgHmmrBNsA1tItMzF8gI3q6i3MpynDLhutDCHMAWhvmHGbOudV6SEyf1x2Jc
# kfX/L4e9wV4skTv62JN3MvfM2ubfsmPYhbHR7sQDK66Rx+gklNgiKHGYWno03M3b
# Gslq9cd6o4+xxeTmRUq144sz2BuMGK5kB5EkvfTWGfsGY4vr0AbI/3OmM42lY8Gd
# qRyC4dDYvN788tuanEsXeSJTznOFzCobuDBGitThQYkrsY4vEc2fUFGjDe7Pui91
# evzJo+ceBsLS80dUmt0iC4XD3GQnqzTdd+Jih4h9NVJ0tSDS6Zxodl6HHRfbnZiG
# /SoMqRiyzQ4vjFOCItSve81xZa+1LXbyqCjOgR1z/ut4VJkNVijQvDaL4kr+BgEw
# CK9DQEAxJSlIxTRwmc7t1qyi8C+V+H9GAuUweUWuq37TzkxNHygNnUR/sSTfgQSX
# 9vwKY2Troov2SdX/GT9Ve5D6RoROZ3nie+40YWXLdhLs6rE4rYDPVzgSa+mwBEZm
# MIKi3wyCMYaqHLQlRuQ+oJBqHaNWyA//oI4YeVuwmrzWHWaTq90Jh7DpphWMxZqp
# 9zKCWpCdg8XbqFbDS39gM/Gs6OrDCYE/hFXhw5E=

...
::  2024.05.31.1 [es] _NET: #766: WMIC Deprecation - rem getNICinfo()
::  2024.05.31.0 [gr] _NET: #781 : Removed NET_WMI and NET_WinRM. Modified scenario DAsrv to reflect those changes.
::  2024.05.24.0 [es] _NET: Feature #765 _NET: Cleanup TSS code
::  2024.05.23.0 [tk] _NET: Bug #760 _NET: Adding Microsoft-Windows-Bluetooth-Policy/Operational event log to NET_Bluetooth scenario
::  2024.04.17.0 [es] _NET: Bug #701: added provider 06C071F2-6C59-5D55-6B31-1578DD063DDC to netsh for scenarios NET_802Dot1x, NET_WLAN, NET_VPN, NET_NPS and NET_RAS
...
$global:TssVerDateNET = "2024.05.31.0"
...
<# Commented in May 2024 by garabier
$NET_WinRMProviders = @(
...
#	"NET_Auth"       = "PSR,SDP,ProcMon, ADS_AUTH + PerfMon DC, Netsh scenario=NetConnection"
	...
	"NET_DAsrv"      = "PSR,SDP, DirectAccess Server RASdiag,WfpDiag ETL log(s),get netlogon.log,ADS_SSL,UEX_WMIAdvanced,UEX_WinRMBase,RAmgmt, Netsh scenario=DirectAcces,WFP-IPsec"
...
$NET_802Dot1x_ETWTracingSwitchesStatus = [Ordered]@{
	...
	'NET_NetworkUX' = $true
	'CommonTask NET' = $True 
	'NetshScenario dot3_wpp,wireless_dbg globallevel=0xff provider="Microsoft-Windows-CAPI2" provider={6EB8DB94-FE96-443F-A366-5FE0CEE7FB1C} provider={06C071F2-6C59-5D55-6B31-1578DD063DDC} keywords=0xffffffffffffffff level=0xff' = $true
	'RASdiag' = $true
	'Procmon' = $true
	'PSR' = $true
	'Video' = $true
...
$NET_NPS_ETWTracingSwitchesStatus = [Ordered]@{
	...
	'NET_WFP' = $true
	'CommonTask NET' = $True 
	'NetshScenario NetConnection provider={06C071F2-6C59-5D55-6B31-1578DD063DDC}' = $true
	'RASdiag' = $true
	'WFPdiag' = $true
	#'Procmon' = $true
	'PSR' = $true
...
$NET_RAS_ETWTracingSwitchesStatus = [Ordered]@{
	...
	'NET_WFP' = $true
	'CommonTask NET' = $True 
	'NetshScenario VpnServer provider={06C071F2-6C59-5D55-6B31-1578DD063DDC}' = $true
	'RASdiag' = $true
	'WFPdiag' = $true
	'Procmon' = $true
	'PerfMon NET' = $true
...
$NET_VPN_ETWTracingSwitchesStatus = [Ordered]@{
 ...
 if ($global:OSVersion.Build -ge 17763){
	 if ($global:Mode -iMatch "Basic"){
		 $NET_VPN_ETWTracingSwitchesStatus.add('NetshScenario VpnClient provider={D84521F7-2235-4237-A7C0-14E3A9676286} provider={06C071F2-6C59-5D55-6B31-1578DD063DDC}',"$True")
	 }else{
		 $NET_VPN_ETWTracingSwitchesStatus.add('NetshScenario VpnClient_dbg provider={D84521F7-2235-4237-A7C0-14E3A9676286} provider={06C071F2-6C59-5D55-6B31-1578DD063DDC}',"$True")
	 }
 }else{
	 # NetSh scenario VpnClient_dbg/VpnClient are not supported on Srv2016
	 $NET_VPN_ETWTracingSwitchesStatus.add('NetshScenario InternetClient_dbg provider={D84521F7-2235-4237-A7C0-14E3A9676286} provider={06C071F2-6C59-5D55-6B31-1578DD063DDC}',"$True")
 }
...
function CollectNET_802Dot1xScenarioLog {
	...
	RunCommands $LogPrefix $Commands -ThrowException:$False -ShowMessage:$False
	# getNICinfo _Stop_			# Commented in May 2024 by edspatar. To be removed on September 2024 #766
	EndFunc $MyInvocation.MyCommand.Name
}
...
function CollectNET_VPNLog {
	...
	$Commands = @( 
		".\scripts\tss_ExportVPNProfiles.ps1 -PrefixTime $PrefixTime -TssPhase $TssPhase" 
		Invoke-Expression "$PsExec -s -i -accepteula -nobanner powershell -ExecutionPolicy Bypass -WindowStyle Hidden -Command `"& { & '$global:ScriptFolder\scripts\tss_ExportVPNProfiles.ps1' $PrefixTime $TssPhase }`" | Out-Null"
	)
	RunCommands $LogPrefix $Commands -ThrowException:$False -ShowMessage:$False
	FwGetCertsInfo _Stop_ Basic
	FwGetProxyInfo _Stop_
...
<# Commented in May 2024 by edspatar. To be removed on September 2024 #766
function getNICinfo {
	param(
		[Parameter(Mandatory=$False)]
		[String]$TssPhase = $global:TssPhase				# _Start_ or _Stop_
...
$EvtLogsBluetooth 	= @("Microsoft-Windows-Bluetooth-BthLEPrepairing/Operational","Microsoft-Windows-Bluetooth-MTPEnum/Operational","Microsoft-Windows-Bluetooth-Policy/Operational") #[takarasz] Bug #760 Adding "Microsoft-Windows-Bluetooth-Policy/Operational" event log
...
$NET_DeprecatedParamList = @(
	#@{DeprecatedParam='NET_AppLocker';Type='Rename';NewParam='UEX_AppLocker'} #es# left here as an example
)
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAcs59mwCqUyUYk
# bl8MyoVK/7gbGsuQSHIui+GlMPFQWqCCDXYwggX0MIID3KADAgECAhMzAAADrzBA
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIF7n+XZd/S0ygBt+mAn/4S8z
# UVhrXcPLZm+3YOgIYlzgMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAVxsFRA+M6GGrQHbid9YKNdi/PlT65b1/Hr5/r+q2qNSZN55FEm9iwCeY
# IdlXAPBA5/MYlvgxn601vIkXoY306vtrOtXZMhbfl72b2jEHdRXX6XmeEqpSoeg+
# bVmOo4ZdcgFsFe8nrrPfySoWSnHoXiqWViMP3xeAglG7PnCQGyFRLlANHKbtdcvA
# beQdFWb2sep6AMoENd0PPPT8ppMjQhAFazXa5Ei4eKqd3JT+DaUaYofGTyqjWvpl
# hoQmaC47aJj6a3JG2UeNfppqqGGcXJ0O9YsmsAPPNnEb6k0UJoERAC0tva2AURcp
# NPCC1q4Iabl5/isUfvsXyLZSOi75C6GCFygwghckBgorBgEEAYI3AwMBMYIXFDCC
# FxAGCSqGSIb3DQEHAqCCFwEwghb9AgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFYBgsq
# hkiG9w0BCRABBKCCAUcEggFDMIIBPwIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCCrezFSa34iV12uq64xSFKooKbuPogPITHW/iSg6xGg1AIGZldTgMoD
# GBIyMDI0MDYxMjE0NTg0OC45M1owBIACAfSggdikgdUwgdIxCzAJBgNVBAYTAlVT
...
# 6hOb/jAiGA8yMDI0MDYxMjEyMDEwMloYDzIwMjQwNjEzMTIwMTAyWjB0MDoGCisG
# AQQBhFkKBAExLDAqMAoCBQDqE5v+AgEAMAcCAQACAhT4MAcCAQACAhIZMAoCBQDq
# FO1+AgEAMDYGCisGAQQBhFkKBAIxKDAmMAwGCisGAQQBhFkKAwKgCjAIAgEAAgMH
# oSChCjAIAgEAAgMBhqAwDQYJKoZIhvcNAQEFBQADgYEAn8Um560BVYkj3MhWCz8b
# o8lvYe2LOzu2GSm3McsqtHIiSom/+rp1GrwKgezdb08FWnAah5gM0WodNcaNxJwm
# NIsWUvwp21nZd7WfCPEKFHxNr6ROB9uWX6h/sOMGziGi7lfR0rCjTLJgxJgREFh5
# 4htmwNojkISXEH3mQOySnakxggQNMIIECQIBATCBkzB8MQswCQYDVQQGEwJVUzET
# MBEGA1UECBMKV2FzaGluZ3RvbjEQMA4GA1UEBxMHUmVkbW9uZDEeMBwGA1UEChMV
# TWljcm9zb2Z0IENvcnBvcmF0aW9uMSYwJAYDVQQDEx1NaWNyb3NvZnQgVGltZS1T
# dGFtcCBQQ0EgMjAxMAITMwAAAeKZmZXx3OMg6wABAAAB4jANBglghkgBZQMEAgEF
# AKCCAUowGgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEi
# BCD7xMy2FU5rkoiFwBzBg7gtqawHdVvPXtGvEy430zv5cDCB+gYLKoZIhvcNAQkQ
...
# 8dzjIOsAAQAAAeIwIgQgVcRWzMm8MsY97pVL5uSEUbOb3qym/bC0rbsoOy7hoqkw
# DQYJKoZIhvcNAQELBQAEggIAUPHYxfSiLWI+4rNEDI3V5UjJjljj/HhLRSUsz/wU
# Tyd1fdEsZKtci0lba03l7CCAy5e2UP4YXe1Ia2ahaUesg0b00ljVjCmWFwvQfwCw
# BmVXG1U6t014QAIzuBU0DYuFsxgYu0AqohgauShUHHlWlvv2VayW9RYBq7VvAWkK
# UgWeOfNamK++VwMW2DgA92jQYmRjfkmIb1f09l8qIPKsLZS7m7Rzrwe40JJdvk5X
# lziSdlWpwq87z2e0D2MYJbbWZAe0J9kkHqHCQVKMVFgG+cvctnYJ0QssPYJmYi0h
# FmK3OTBOx4ARzkwA9ee2CABUsepmv+IVUHasQf0VL1kJF+N+T1Dpn18ZHG0B9yqD
# IphzpxawEyfYfGmc8ZkFRpDX6F2dv3+OY3MnvW2yYUlU/8vgoedmU1F1k61K3Gdh
# 4Lt7j9Mv/wlNsUd+IZ3H1HLQk17ejnmClZedJ5wrNR66ZB5Ef6zdcr5PH875Hovb
# EG2BL0NZecWK3vVKnjRsBR9wgE9ehPB5GqOOrrFaboYZmegE+yhnaDTRaYlIK6Mc
# 6RbeBc1metUrZoKCbOiwD+ThWzMp5x5Qrukqt5fo3bDFdEWIbdFSxMkmwzQ07utb
# 8R6f0UGDug2kd/S0shqyDMKa9C0DIOCMh389UVZYRjaytsQW4786VEcNh12yb+bK
# he0=

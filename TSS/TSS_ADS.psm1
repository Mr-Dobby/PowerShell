...
<# latest changes
::  2024.05.21.0 [tk] _ADS: Bug #759 Fixing file names containing username with <blank> character in CollectADS_UserInfoLog using $global:EnvUserName
::  2024.05.14.0 [mm] _ADS: added new EVTX logs to W32Time #634
::  2024.05.03.0 [mm] _ADS: moved CRUtil and GetRemoteToken scripts and binaries into TSS
...
$global:TssVerDateADS= "2024.05.21.0"
...
function CollectADS_UserInfoLog {
	...
	$Commands = @(
		"GPresult.exe /h $PrefixTime`GPresult-H_$global:EnvUserName`$TssPhase.htm /f"
		"GPresult.exe /z $PrefixTime`GPresult-Z_$global:EnvUserName`$TssPhase.txt /f"
		"GPresult.exe /v | Out-File $PrefixTime`GPresult-V_$global:EnvUserName`$TssPhase.txt"
		"whoami.exe /UPN | Out-File $PrefixTime`WhoAmI_UPN_$global:EnvUserName`$TssPhase.txt"
		"klist.exe cloud_debug | Out-File $PrefixTime`klist_cloud_$global:EnvUserName`$TssPhase.txt"
		"$Sys32\certutil.exe -v -user -store my | Out-File $PrefixTime`mystore_$global:EnvUserName`$TssPhase.txt"
		"REG.exe export HKCU $PrefixTime`RegHive_HKCU_$global:EnvUserName`.hiv /Y"
	)
	RunCommands $LogPrefix $Commands -ThrowException:$False -ShowMessage:$False
	FwGetWhoAmI
	FwGetDSregCmd
...
function CollectADS_W32TimeLog {
	...
	($EvtLogsW32Time) | ForEach-Object { FwAddEvtLog $_ _Stop_}
...
#region groups of Eventlogs for FwAddEvtLog
	...
	$EvtLogsW32Time = @("Microsoft-Windows-Time-Service/Operational", "Microsoft-Windows-Time-Service-PTP-Provider/PTP-Operational")
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDH39yU6zBv+v37
# IttlXTMoTbv6CM63PCjL+dqgsbLD3qCCDXYwggX0MIID3KADAgECAhMzAAADrzBA
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEII53QLex5rtBYJaPOo/LyVYA
# X/BzksGIXiqBtuGWje8CMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAtM/1UkRZT1nf3yDNA5MgJ9qSBeVtChWalYmbQsLGcfZmFICBNfl8X8db
# sF31z6e5qHiNc2pjvkz0zfa0zvn+UdHuDLWh4of9csNbSzabnU88vQsQfUn3M27p
# sRQta4k95f/PNsbCBsKCvxjEyMeEZc0YbxAOpf7QPNSGfHPkovqUxxpd7pCoIiPK
# oE4i+oUhUQ0MmK9md0QsaKOKGsHURSUYfr1hPnXAnvEx4RRPmKCEzIW0StsOC2s+
# r+ITzZbPGwhJgYICnoLqheYhkPFWfSKMWYLFF1GzjoPaSQpkuufgJjpH5FqNWnzS
# 8HSFXjirdUB1dHDNICAyuiZ2qxSNnaGCF5QwgheQBgorBgEEAYI3AwMBMYIXgDCC
# F3wGCSqGSIb3DQEHAqCCF20wghdpAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFSBgsq
# hkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCCSMt9vjdmH68yrcd7fT+J02QDMZ2QCHWNblW/z73TvNwIGZkZGMttd
# GBMyMDI0MDYxMjE0NTg1NC41NjhaMASAAgH0oIHRpIHOMIHLMQswCQYDVQQGEwJV
...
# CSqGSIb3DQEJBDEiBCAWth2HbQtMS0mlQ7yZg7STNlWb1xai4gVso/krCqAiuTCB
...
# YZTv8URqkr31jMswDQYJKoZIhvcNAQELBQAEggIAsR0IT1EkmHrS/ZaTtGbZ+Ndb
# N/4NBoOvbnS58ZnHgqIO9x4hPWwztxe5QTd0BRHsBfkWrd1PGiElb+BD8yiJK1Qg
# +Ov5ojw18+lB5hQCf+KzfdIemDdsRXdZS8pXB+BdChMFeDtY3dOXQSTSXhSjvBYv
# 2s9JTzPzXCRPoJjnaiKUD7GY0s3jdNvyzam/JAVDwLQ/KPRt8Yva0b+W+frT3PlO
# Wjm0F/nYB8xlDH1SBW5dcvHus5Uy6+WOrFbAOC5g4Z3REz67ByoxqmKRO8b9gco+
# IlDBBvImcjbw0aEqwpLeVIbXQoVE74KtQG/qYAgrwrLjXqNN6DBdiUngYh4oJo1E
# HICV0ft8yABQr9QUyMchvFlMPrFV5wcn45VRvYw6jRGadvsN+8OCgwysXKCzKruM
# U2eiglKucDBaZixBQywCxAIrUXrYUwdBRm83szDpxZ0cOBN2wU5Lpqx8gMo56FO2
# J1m/BVEuF+miPfcJSvyhdjhtDijXWY9+4VKEKk1mJ+oo59eO0a0qQ4BFCV3ArBnI
# lWV97JJhifjtP4RkfIfiyiNn2V54kanrm4PNH/65WChbSKnxNcA1duTnriX8YQVY
# jF5eP0HqvfoFI5PUnOLTzqDBsJA/xhyBAfI/xCLMvvnBJf2Jpo+Ja/mXYkxs2Ig1
# syMiWazvLsAZmXB7dF8=

...
$wfp = @("net_netio_KB4563820", "net_wfp_KB5036792")
...
"@
	...
	try	{
        ...
        # Windows 10
        $vpnConn = (Get-VpnConnection -ErrorAction Ignore | Where-Object { $_.IsAutoTriggerEnabled -eq $true})
        if ($vpnConn) {
                ...
                if ($trustedNetworks) {
                    ...
                    foreach ($conn in $connections) {
                        if ($vpnConn.Name -ne $conn.InterfaceAlias) {
                            if (-not $trustedNetworks -contains $conn.Name) {
...
#region wfp
#region net_wfp_KB5036792
<# 
Component: WFP
Checks for:
 Missing registry key required by system causing various issues 
 including failed Windows Defender AV cloud service connectivity 
Created by: tdimli
#>
function net_wfp_KB5036792
{
    param(
        [Parameter(Mandatory=$true,
        Position=0)]
    ...
    $issueMsg = @"
This system is missing the profile for built-in NetworkService account.
Following registry hive holding this information is missing:
    HKEY_USERS\S-1-5-20

This may cause various issues including:
    Many services running under this account may fail to start 
     or not function correctly
    Failed Windows Defender AV cloud service connectivity

Resolution
Restore the missing registry hive from a recent backup or reinstall Windows.
"@
	...
	try	{
        ...
        # Windows 10
        $regKeyPath = "Registry::HKEY_USERS\S-1-5-20"
        if (-not (Test-Path -Path $regKeyPath -ErrorAction Ignore)) {
            ReportIssue $issueMsg $ISSUETYPE_ERROR
        }
	}
	catch {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDxMRS7ekbgsiCG
# oz0KoQFlRB5GZ6ErOffK9KhJdQl69aCCDXYwggX0MIID3KADAgECAhMzAAADrzBA
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIIz7HdWOGZmnyAVy8We6r7ej
# NztcQB7EmivHBR8CY6+yMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEACsirLG15iYQwVZfLXKwbz7KDLZK4AnOoYjFYxp1wthrh9+R85Jj3DF9S
# qKuWhdQppSqIFAQzYXlE608KPvFueYgW4vzhxuObzthL7WKcJrloQbnFBhht9RR6
# Km+QZDmy+mcBFZmIkSXGKTuCHKn/lfAUl8RS2ua4FqNG997+AZbJEpQQ/86YDOZt
# ANv9t7RLOP0VJTfEFOoPyqmKyU6phQ94OTiWeN1+HM7YTNSwTY4WchWziygsOXXg
# IXvQZyDsti6bJnmYAJ8z4Hkq2HmyzZ4FrY6Qu/te0QRy6zOJXXgv8sACObGNTfhB
# xL8tOt1UiQbqj0YQx7RGXdCUXgERIqGCF5QwgheQBgorBgEEAYI3AwMBMYIXgDCC
# F3wGCSqGSIb3DQEHAqCCF20wghdpAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFSBgsq
# hkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCBrr25ML3q+tBBBbK0kH2J1aO+NptzuKWSMcfN7VxJF+QIGZkYbygVT
# GBMyMDI0MDYxMjE0NTg0OS42NDVaMASAAgH0oIHRpIHOMIHLMQswCQYDVQQGEwJV
...
# CSqGSIb3DQEJBDEiBCB0aJwFceStqAhc1lvnbeg1OvESZs9zcnDDHzl6xmG1DzCB
...
# RbGqY0XQ6xvnFLwwDQYJKoZIhvcNAQELBQAEggIA2HfwinbJKn+1jox1on+0JwaS
# KGUFboaM/NURcbPKzRQ6tTS9at+mKEST1l7Qhn3TddY3bP8EtO2DLj/BdwoCLlGb
# 5pwXdpqbyeXlhhZ3JaX4F+nOb6ZGfJPkZN3/YGKjpRz/WE4zLJao1EN4YZZBP0kZ
# hBYnWgRcFtmiyTpnu3XSSt9luCrt/MgT11JREC/VIMownJSwohcx+2PAtZBfpRNM
# WVqxugu07XoBGcO0UbgXemVZPusFIUB02Ubf7ONqUujXFwX6Nk/729sw2yUzshmB
# 9TgLPsuLHNCFUmGOcskzc7GjFWJyVnNAHqIMvl/MY6aBJ2dFpLwOwhdd0Aep2VNH
# 38LVc+LWyG0YYT/J+NDD3E43Arsn4HIZisLvXgY0yuC3t8r5sw/2oTLUy5ReM3S2
# WHe1un9uHr2P32uVEy4Vo3B6++jSxbaH/veNwWHqzH0zbi43RLfHdos6VE+jLTW0
# BGQy79WSvPpAHor+Y64TRuc2xSYORmFKxMXxZkGGk/LuEcTRsHgOhkA5ZbcNcrUA
# oKzW0QXHgDNIC9aB+R3u+MguFnjJVSVqeskZjAbfWvb8vxuvviL8ixR5XSgWiKmz
# DqHeYkpuDkJqJU2YHrk/eiEFkkcOiKtAs78NZVW42Z5PYpw80HepYs1qszId3oir
# dc+VZT9WA2TbZhqPuuE=

...
# March 2020
#
# Diagnostic functions for PRF area

# version
$PRF_version = "1.0.240304.0"

# Area and Area/Component arrays
$PRF = @("xray_prf_startmenu")

#Component/Diagnostic Function arrays
$xray_prf_startmenu = @("prf_startmenu_KB5036502")

# begin: diagnostic functions

#region prf_startmenu_KB5036502
<# 
Component: StartMenu
Checks for:
 Ensures TrustedInstaller is the owner of some registry key used by Windows Start Menu
Created by: nidietr
#>
function prf_startmenu_KB5036502
{
    param(
    ...
    $issueMsg = @"
The ownership of {0} is incorrectly set to {1}.

Changing the ownership of registry keys owned by the Windows may lead to issues, including the Start Menu to show blank/empty icons.

Registry keys owned by the operating system shouldn't be modified, and their ownership neither.

Please restore the ownership of this regkey to NT SERVICE\TrustedInstaller.
"@
    ...
    try
    {
        ...
        $SID_TRUSTEDINSTALLER = 'S-1-5-80-956008885-3418522649-1831038044-1853292631-2271478464'
        $KEY_PATH = "HKLM:\SOFTWARE\CLASSES\CLSID\{4234d49b-0245-4df3-b780-3893943456e1}"
        
        $acl = Get-Acl $KEY_PATH
        $owner = $acl.Owner
        $owner_sid = (New-Object System.Security.Principal.NTAccount($owner)).Translate([System.Security.Principal.SecurityIdentifier]).Value
        
        if ($owner_sid -ne $SID_TRUSTEDINSTALLER)
        {
            $issueFound = $true
        ...
        if ($issueFound) {
            # issue present
            $issueMsg = [string]::Format($issueMsg, $KEY_PATH, $owner)
...
#endregion prf_startmenu_KB5036502
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCgpMYAJB342Qvi
# HsAKqvf4UCETo+KPCNwKFZ/+NAG+N6CCDXYwggX0MIID3KADAgECAhMzAAADrzBA
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIF8DRuc55to83Ud6nLltDV3B
# BbTZOKLfRigEGOnbNi+xMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAAwu58CmsrDfCBGlDJ7TJ52xU1+Are1rcSCGqTC5+1TtQmTfmi1Wg9oCF
# 8wvSwo7iJmg3cUR5TwfC5Trixrlh/Vluil3ZxasofAMjrSxbZ2cYFCPGc9fboiX9
# 4Pg1YbuuaTx59lIRK62ugsY5PC3ieilICCMMC0j5/yICCeMki3D1I2cA6L6btpRh
# VlSAzw8rYTBDoCYoH7Hm/FxdOYoOTNA0HAJUOYS9jEWEGoGAKQhMinriPBKxB2ew
# Bi2mwhbzOsdGu+D+B3RiYUBxjZGiDIX82PjTFvnzigrlEaATh6z61D+BFEFWKthn
# HuXOaCyzwNJciYn2r06SK8FUcswHiKGCF5QwgheQBgorBgEEAYI3AwMBMYIXgDCC
# F3wGCSqGSIb3DQEHAqCCF20wghdpAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFSBgsq
# hkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCDilB2qJbCDugOCsJDPXPMW52A+pV64HV+g7R1TR0sIGgIGZkYSOqaN
# GBMyMDI0MDYxMjE0NTg0OS43NDZaMASAAgH0oIHRpIHOMIHLMQswCQYDVQQGEwJV
...
# CSqGSIb3DQEJBDEiBCDN5HQKaMgymoUFRj0SfO7MItLNOkEI38qh4X5bQ2PYGzCB
...
# e8cj7H/1NlVkem4wDQYJKoZIhvcNAQELBQAEggIAZA/x9Yk1w7IA7p7hhEKVGz9s
# FMec79l+6Lxu2OBmOGH77zmF9dAmJhNMIloQpPKKVpAaawTY3I/RiEWQO/qfBI/F
# C2QXZZuxBBa2K8BT3HXBMXLtaH/dEe4E3RpzX/Xga/gcY46AYi260erOem+oaUYF
# psC5ZWdxgXDN3DREaICRlrZIMOiVQ/Kn3CTOFyDVNRkG/R8QOSvwhPoupz5Au4I6
# Lz9FmoRxBM7mBa7g7CQp7cAwars5wMxcTfkUNzz/PvzqOUNn4yB2auDH8xuN8EVu
# DzBjK4mzpz39zKFjwxHC8kYcmdPeYTHg8GLbhCKEBO1rDTvO1iqENOloT3IR2t5Z
# B3czu0wAnF04XwB+/2SPoUNEibJizz++ebwghF976WyvIp9YI7NB2WPEJMrd3WgH
# bj8utS+Xk8GBMYnYLZIRv9A8M3eGTNg2YbPi1AV/I/dz2UZXGlw8d6SOQ5HJ/rwP
# 3vjuhXC82dPK8hq6WnE7kdZHlm1S4FrFpdolH+/yRQAtrWdHkId9OBQ05My7wdvc
# coLhqD9czPoWE4s59fvSORXUSxRBjXEeQ7MWFzy6eAvNMArA7Rhz1T7nmJ7XarN/
# gJjDahS549JRCx7bcM9dlyTGuJrdLaWS6YMyowxYZv2HPEhZUF3Qmd3QPj6uM10U
# WYl3w3kNdqjeNSDxsDg=
